...
export const metadata: Metadata = {
	title: "Over Ons",
	description: `Leer meer over ${getSiteTitle()}. Onze missie is jou voorzien van de beste kortingen en deals in België.`,
	alternates: {
		canonical: "/over-ons",
	},
};
		...
		<div className="max-w-3xl mx-auto px-4 py-12">
			<JsonLd
				data={createBreadcrumbJsonLd([
					...
					{ name: "Over Ons", url: `${getSiteBaseUrl()}/over-ons` },
				])}
			/>
			...
			<div className="prose prose-gray max-w-none space-y-6">
				<section>
					...
					<p className="text-gray-600 leading-relaxed">
						...
						die beschikbaar zijn op de markt. Wij geloven dat iedereen de kans
						moet hebben om te besparen op aankopen, en wij zijn hier om dat
						mogelijk te maken.
					</p>
				</section>
				...
				<section>
					...
					<p className="text-gray-600 leading-relaxed">
						Bij {getSiteTitle()} verzamelen we dagelijks de nieuwste
